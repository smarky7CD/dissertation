...
We refer to these resulting elements as pre-images of $h$, and the algorithms that compute them as inversion algorithms. % If explanation of MurmurHash2Inverse, put it here
